...
# setup parallel for computing, try 192 cores, 10,000 iterations
...
write.csv(results_df,"simulation_t5_full.csv",row.names = F)
...
write.csv(grouped.results,"simulation_t5_summarised.csv",row.names = F)
