...
#write csv for each
write.csv(results.plot.final[[1]],"t10_sims_method.csv",row.names = F)  #1000 x 9

#csv write for only.unbiased t10 sims, then process simulations outside compute Canada
write.csv(results.plot.final[[2]],"t10_sims_only_unbiased.csv",row.names = F) #1000 x 3
...
write.csv(plot.final,"t10_sims_MCSE.csv",row.names = F)
